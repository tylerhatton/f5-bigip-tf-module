...
| f5\_management\_private\_ips | Private IPs of F5 BIG-IP's management interface. |
| f5\_internal\_private\_ips | Private IPs of F5 BIG-IP's internal interface. |
| f5\_external\_private\_ips | Private IPs of F5 BIG-IP's external interface. |
